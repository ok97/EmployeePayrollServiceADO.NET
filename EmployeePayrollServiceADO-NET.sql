...
-- Create Table
 ...
 create table payroll_service(EmployeeId int ,EmployeeName varchar(20),PhoneNumber varchar(10) , Address varchar(20) , Department varchar(20),Gender char(1) ,BasicPay float , Deductions float ,TaxablePay float ,Tax float, NetPay float , StartDate DATE ,City varchar(10) ,Country varchar(10) );
